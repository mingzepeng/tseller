...
$user_name = $real_name =  $taobao_id = $mobile = $password  = $email = $user_desc = $user_group = '';
...
if (Common::isPost ()) {
	...
	if($exist){
		...
		$input_data = array ('user_name' => $user_name, 'password' => md5 ( $password ),'taobao_id'=>$taobao_id, 'real_name' => $real_name, 'mobile' => $mobile, 'email' => $email, 'user_desc' => $user_desc, 'user_group' => $user_group );
