...
$user_id = $user_name = $taobao_id = $real_name = $mobile = $password = $email = $user_desc = $user_group = '';
...
if (Common::isPost ()) {
	...
	if($real_name=="" || $mobile =="" || $email =="" || ($user_id !=1 && $user_group <= 0) ){
		...
		$update_data = array ('real_name' => $real_name, 'mobile' => $mobile,'taobao_id'=>$taobao_id,
