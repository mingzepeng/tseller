<?php /* Smarty version 2.6.26, created on 2013-07-24 17:29:54
         compiled from admin/group_role.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'admin/group_role.tpl', 9, false),array('function', 'html_checkboxes', 'admin/group_role.tpl', 17, false),)), $this); ?>
...
" class="block-body collapse in">
			<?php echo smarty_function_html_checkboxes(array('name' => 'menu_ids','options' => $this->_tpl_vars['role']['menu_info'],'checked' => $this->_tpl_vars['group_role'],'separator' => "&nbsp;&nbsp;",'labels' => '1'), $this);?>
