<?php /* Smarty version 2.6.26, created on 2013-07-24 20:43:13
        ...
        <div id="page-stats" class="block-body collapse in">
              ...
              <thead>
                <tr>
					...
					<th style="width:80px">精弘账号</th>
					<th style="width:100px">淘宝账号</th>
...
?>				 
					...
					<td><?php echo $this->_tpl_vars['user_info']['taobao_id']; ?>
</td>
...
" title= "修改" ><i class="icon-pencil"></i></a>
					...
					<?php if ($this->_tpl_vars['user_info']['user_id'] != 1): ?>
