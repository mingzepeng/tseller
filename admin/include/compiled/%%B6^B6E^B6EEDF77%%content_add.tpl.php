<?php /* Smarty version 2.6.26, created on 2013-07-25 21:34:24
         compiled from content/content_add.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'content/content_add.tpl', 25, false),)), $this); ?>
	...
	<div id="myTabContent" class="tab-content">
		  <div class="tab-pane active in" id="home">
           ...
           <form id="tab" method="post" action="" autocomplete="off">
				<label>标题</label>
				<input type="text" name="type" value="<?php echo $this->_tpl_vars['_POST']['type']; ?>
" class="input-xlarge" autofocus="true" required="true" >

				<label>封面图片</label>
				<input type="text" name="img_url" value="<?php echo $this->_tpl_vars['_POST']['img_url']; ?>
" class="input-xlarge"  required="true">

				<label>内容类型</label>
				 <?php echo smarty_function_html_options(array('name' => 'type_id','id' => 'DropDownTimezone','class' => "input-xlarge",'options' => $this->_tpl_vars['content_type_options_list'],'selected' => 0), $this);?>
				...
				<label>内容</label>
				<textarea name="content" rows="5" class="input-xlarge"><?php echo $this->_tpl_vars['_POST']['content']; ?>
</textarea>
