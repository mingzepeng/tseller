<?php /* Smarty version 2.6.26, created on 2013-07-24 20:17:03
         compiled from admin/group_add.tpl */ ?>
	...
	<div id="myTabContent" class="tab-content">
		  <div class="tab-pane active in" id="home">
           ...
           <form id="tab" method="post" action="">
				<label>账号组名称</label>
				<input type="text" name="group_name" value="<?php echo $this->_tpl_vars['_POST']['group_name']; ?>
" class="input-xlarge" required="true" autofocus="true" >
				<label>描述</label>
				<textarea name="group_desc" rows="3" class="input-xlarge"><?php echo $this->_tpl_vars['_POST']['group_desc']; ?>
</textarea>
