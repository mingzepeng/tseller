<?php /* Smarty version 2.6.26, created on 2013-07-25 14:07:12
         compiled from admin/quicknote_modify.tpl */ ?>
	...
	<div id="myTabContent" class="tab-content">
		  <div class="tab-pane active in" id="home">
           ...
           <form id="tab" method="post" action="">
				...
				<textarea name="note_content" rows="3" class="input-xlarge" required="true"><?php echo $this->_tpl_vars['quicknote']['note_content']; ?>
</textarea>
