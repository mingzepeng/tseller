<?php /* Smarty version 2.6.26, created on 2013-07-25 09:13:49
         compiled from admin/module.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'admin/module.tpl', 74, false),)), $this); ?>
...
?>
					...
					<input type="checkbox" name="menu_ids[]" value="<?php echo $this->_tpl_vars['menu']['menu_id']; ?>
" disabled>
					<?php else: ?>
					<input type="checkbox" name="menu_ids[]" value="<?php echo $this->_tpl_vars['menu']['menu_id']; ?>
" >
			...
			<?php if ($this->_tpl_vars['module_id'] > 1): ?>
			<label>选择菜单模块</label>
